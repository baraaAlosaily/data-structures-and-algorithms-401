...
//        assertEquals(false,list.includes());
    ...
    @Test void greaterThan(){
        ...
        list.insert(20);
        list.kthFromEnd(7);
        assertEquals(-1,list.kthFromEnd(7));
    }
    //k and the length of the list are the same
    @Test void sameLength(){
        LinkedList list=new LinkedList();
        list.insert(5);
        list.insert(10);
        list.insert(15);
        list.insert(20);
        list.kthFromEnd(4);
        assertEquals(-1,list.kthFromEnd(4));
    }
//k is not a positive integer
    @Test void notPositive(){
        LinkedList list=new LinkedList();
        list.insert(5);
        list.insert(10);
        list.insert(15);
        list.insert(20);
        list.kthFromEnd(-2);
        assertEquals(-1,list.kthFromEnd(-2));
    }
    ...
    @Test void HappyPath(){
        ...
        assertEquals("{4} -> {1} -> {5} -> {2} -> {6} -> {3} -> Null",new1.show());
    }
    ...
    @Test void longer(){
        ...
        LinkedList new1=new LinkedList();
        new1.head= new1.zipLists(list1,list2);
        assertEquals("{4} -> {1} -> {5} -> {2} -> {6} -> {3} -> {7} -> {8} -> Null",new1.show());
    }
    // If one of them null
    @Test void oneNull(){
        LinkedList list1=new LinkedList();
...
//        list1.insert(3);
        ...
        LinkedList new1=new LinkedList();
        new1.head= new1.zipLists(list1,list2);
        assertEquals("{4} -> {5} -> {6} -> Null",new1.show());
